...
import com.tianji.learning.domain.dto.LearningPlanFormDTO;
...
public class LearningLessonController {
    ...
    @ApiOperation("创建学习计划")
    @PostMapping("/plans")
    public void createLessonPlan(@RequestBody LearningPlanFormDTO dto) {
        learningLessonService.createLessonPlan(dto.getCourseId(),dto.getFreq());
    }
